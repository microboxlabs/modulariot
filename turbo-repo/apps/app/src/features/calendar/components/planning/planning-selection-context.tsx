...
// Generic time-window primitives now live in @microboxlabs/miot-calendar-ui.
// Re-export them here so existing `./planning-selection-context` importers keep
// resolving the same names (the package is now the single source of truth).
export {
  TIME_WINDOW_COLORS,
  TimeWindowUtils,
  getWeekOfMonth,
