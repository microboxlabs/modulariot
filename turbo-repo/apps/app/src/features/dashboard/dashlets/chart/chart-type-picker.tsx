...
export const CHART_TYPE_DEFS: { value: ChartType; labelKey: string; descKey: string }[] = [
  { value: "line",    labelKey: "dashboard.dashlets.chart.typeLine",    descKey: "dashboard.dashlets.chart.typeLineDesc" },
  { value: "bar",     labelKey: "dashboard.dashlets.chart.typeBar",     descKey: "dashboard.dashlets.chart.typeBarDesc" },
  { value: "pie",     labelKey: "dashboard.dashlets.chart.typePie",     descKey: "dashboard.dashlets.chart.typePieDesc" },
  { value: "gauge",   labelKey: "dashboard.dashlets.chart.typeGauge",   descKey: "dashboard.dashlets.chart.typeGaugeDesc" },
  { value: "scatter", labelKey: "dashboard.dashlets.chart.typeScatter", descKey: "dashboard.dashlets.chart.typeScatterDesc" },
];
      ...
      <div ref={containerRef} className="relative">
        ...
        >
          <span className="flex items-center gap-2">
            ...
            {tr(activeDef.labelKey, dictionary)}
          </span>
          ...
          <div className="absolute z-50 mt-1 w-full overflow-hidden rounded-lg border border-gray-200 bg-white shadow-lg dark:border-gray-600 dark:bg-gray-800">
            {CHART_TYPE_DEFS.map((def) => {
              ...
              return (
                ...
                >
                  <Icon className={`h-7 w-7 shrink-0 ${isActive ? "text-blue-600 dark:text-blue-400" : "text-gray-500 dark:text-gray-400"}`} />
                  <div>
                    <div className={`text-sm font-medium leading-tight ${isActive ? "text-blue-600 dark:text-blue-400" : "text-gray-900 dark:text-white"}`}>
                      {tr(def.labelKey, dictionary)}
                    </div>
                    <div className="text-xs text-gray-500 dark:text-gray-400">
                      {tr(def.descKey, dictionary)}
                    </div>
                  </div>
                </button>
              );
