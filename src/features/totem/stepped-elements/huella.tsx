...
export default function Huella({ setCurrentStep, currentStep, dict }: { setCurrentStep: (step: number) => void, currentStep: number, dict: I18nRecord }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-5 bg-white dark:bg-gray-800 rounded-2xl p-10 shadow-md portrait:w-full">
      <div className="flex flex-col items-center justify-center gap-4">
        <h1 className="text-[4vh] portrait:text-[4vw] font-light text-gray-900 dark:text-gray-100">{(dict.totem as I18nRecord).fingerprint_scan as string}</h1>
      </div>
