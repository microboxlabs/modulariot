...
export default function HistoricLoads( {
  ...
  return (
    <div className="h-full w-full flex flex-col overflow-hidden">
      ...
      <div className="sm:hidden relative select-none cursor-pointer transition-all duration-300 hover:bg-blue-700 dark:hover:bg-blue-700 flex flex-row gap-2 items-center justify-center h-10 w-full bg-blue-600 dark:bg-blue-600 text-white rounded-lg rounded-b-none" onClick={() => setIsSelectorOpen(!isSelectorOpen)}>
