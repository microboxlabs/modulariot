...
export default function Rut({ setCurrentStep, currentStep, dict }: { setCurrentStep: (step: number) => void, currentStep: number, dict: I18nRecord }) {
  return (
      <div className="flex flex-col items-center justify-center gap-5 bg-white dark:bg-gray-800 rounded-2xl p-10 landscape:p-10 shadow-md">
        <h1 className="text-[5vh] portrait:text-[5vw] text-gray-700 font-light dark:text-gray-300">{(dict.totem as I18nRecord).write_your_rut as string}</h1>
