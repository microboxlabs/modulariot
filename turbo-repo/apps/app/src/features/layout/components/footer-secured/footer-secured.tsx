...
export default function FooterSecuredLayout({ messages }: FooterSecuredProps) {
  return (
    <Footer
      ...
      theme={{
        root: {
          base: "w-full rounded-none bg-white fixed bottom-0 shadow dark:bg-gray-800 border-t border-gray-200 dark:border-gray-700 md:flex md:items-center justify-between px-5 py-3",
        },
      }}
    >
      <FooterCopyright
