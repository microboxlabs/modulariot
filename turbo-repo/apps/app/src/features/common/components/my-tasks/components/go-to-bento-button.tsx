...
export function GoToBentoButton({
  ...
  return (
    <Link href={`/task/edit/${taskId}`} className="w-fit h-fit group">
      <Button
        ...
        theme={{
          color: {
            blue: "bg-blue-700 text-white hover:bg-blue-700 focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800",
          },
        }}
      >
