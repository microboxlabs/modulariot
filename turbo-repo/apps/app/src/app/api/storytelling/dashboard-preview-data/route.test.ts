...
vi.mock("node:fs/promises", async (importOriginal) => ({
  ...
  readFile: vi.fn().mockResolvedValue('{"RAW":{},"CO":{}}'),
}));

import { GET } from "./route";

describe("GET /api/storytelling/dashboard-preview-data", () => {
  ...
  it("serves the fixture JSON when flag is on and authenticated", async () => {
    const res = await GET();
