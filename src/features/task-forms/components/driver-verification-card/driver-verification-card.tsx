...
export default function DriverVerificationCard({ msg, task, lang}: TaskFormProps){
  return (<Card>
    <form className="flex flex-col min-w-96 p-8 justify-center gap-9">
      ...
      <div>
        <div className="flex flex-col gap-y-2">
          <Label htmlFor="serviceCode">
            {((msg!.fields as I18nRecord).service as I18nRecord).label as string}
          </Label>
          <TextInput
            id="serviceCode"
            name="serviceCode"
            placeholder={((msg!.fields as I18nRecord).service as I18nRecord).placeholder as string}
      ...
      <div>
        <Button as={Link} href={`/${lang}/task/edit/${task.id}?step=step2`}
          color="blue"
          type="submit"
