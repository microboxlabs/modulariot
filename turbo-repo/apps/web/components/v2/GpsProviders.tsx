...
// ============================================================
// Proveedores GPS — ¿conoces la calidad de tus señales? (frecuencia + latencia + integridad)
...
const UI = {
  es: {
    ...
    h1: "¿Conoces la calidad de tus señales GPS?",
    introP1: "Tus análisis valen lo que vale tu señal — y la calidad depende de la ",
    introB1: "frecuencia, la latencia y la integridad de cada pulso",
    introP2: ". ",
    introB2: "12 pulsos por minuto",
    introP3: " garantizan el estándar de calidad de ModularIoT; ",
    introB3: "20",
    ...
    statPrecision: (std: number) => `cumple calidad (${std}/min)`,
    ...
    stPrecision: "Calidad ModularIoT",
    stBajo: "Bajo estándar",
    stMuyBajo: "Muy bajo",
    rankOf: (rank: number, total: number) => `#${rank} de ${total} por calidad de señal`,
    devices: "dispositivos",
    shareOfSignal: (p: number) => `${p}% de la señal`,
    pulsesMin: "pulsos/min",
    gaugePrecision: "12 · Calidad",
    gaugeMining: "20 · Minería",
    providerLatency: "latencia del proveedor",
    signalsMoving: "señales en movimiento",
    cumpleMineria: (min: number, mbl: number) => `Cumple el estándar de minería (${min}/min) y el de calidad ModularIoT (${mbl}/min).`,
    cumplePrecision: (min: number, mbl: number) => `Cumple el estándar de calidad ModularIoT (${mbl}/min); aún no el de minería (${min}/min).`,
    noCumple: (mbl: number) => `No alcanza el estándar de calidad ModularIoT (${mbl}/min) — sus análisis son menos confiables.`,
  ...
  en: {
    ...
    h1: "Do you know the quality of your GPS signals?",
    introP1: "Your analytics are only as good as your signal — quality depends on the ",
    introB1: "frequency, latency and integrity of every pulse",
    introP2: ". ",
    introB2: "12 pulses per minute",
    introP3: " guarantee ModularIoT's signal-quality standard; ",
    introB3: "20",
    ...
    statPrecision: (std: number) => `meets quality (${std}/min)`,
    ...
    stPrecision: "ModularIoT quality",
    stBajo: "Below standard",
    stMuyBajo: "Very low",
    rankOf: (rank: number, total: number) => `#${rank} of ${total} by signal quality`,
    devices: "devices",
    shareOfSignal: (p: number) => `${p}% of the signal`,
    pulsesMin: "pulses/min",
    gaugePrecision: "12 · Quality",
    gaugeMining: "20 · Mining",
    providerLatency: "provider latency",
    signalsMoving: "signals in motion",
    cumpleMineria: (min: number, mbl: number) => `Meets the mining standard (${min}/min) and the ModularIoT quality standard (${mbl}/min).`,
    cumplePrecision: (min: number, mbl: number) => `Meets the ModularIoT quality standard (${mbl}/min); not yet the mining one (${min}/min).`,
    noCumple: (mbl: number) => `Does not reach the ModularIoT quality standard (${mbl}/min) — its analytics are less reliable.`,
    thProvider: "Provider",
    thDevices: "Dev.",
  ...
  pt: {
    ...
    h1: "Você conhece a qualidade dos seus sinais de GPS?",
    introP1: "Suas análises valem o que vale o seu sinal — e a qualidade depende da ",
    introB1: "frequência, da latência e da integridade de cada pulso",
    introP2: ". ",
    introB2: "12 pulsos por minuto",
    introP3: " garantem o padrão de qualidade da ModularIoT; ",
    introB3: "20",
    ...
    statPrecision: (std: number) => `atinge qualidade (${std}/min)`,
    statMining: (std: number) => `atinge mineração (${std}/min)`,
    statDevices: "dispositivos em movimento",
    nOfM: (n: number, total: number) => `${n} de ${total}`,
    stMineria: "Padrão mineração",
    stPrecision: "Qualidade ModularIoT",
    stBajo: "Abaixo do padrão",
    stMuyBajo: "Muito baixo",
    rankOf: (rank: number, total: number) => `#${rank} de ${total} por qualidade do sinal`,
    devices: "dispositivos",
    shareOfSignal: (p: number) => `${p}% do sinal`,
    pulsesMin: "pulsos/min",
    gaugePrecision: "12 · Qualidade",
    gaugeMining: "20 · Mineração",
    providerLatency: "latência do provedor",
    signalsMoving: "sinais em movimento",
    cumpleMineria: (min: number, mbl: number) => `Atinge o padrão de mineração (${min}/min) e o de qualidade ModularIoT (${mbl}/min).`,
    cumplePrecision: (min: number, mbl: number) => `Atinge o padrão de qualidade ModularIoT (${mbl}/min); ainda não o de mineração (${min}/min).`,
    noCumple: (mbl: number) => `Não atinge o padrão de qualidade ModularIoT (${mbl}/min) — suas análises são menos confiáveis.`,
    thProvider: "Provedor",
    thDevices: "Disp.",
