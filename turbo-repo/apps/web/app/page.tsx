        ...
        <div className="flex min-h-screen flex-col items-center justify-center px-4 py-16 text-center sm:px-6">
          <div className="w-full max-w-2xl">
            ...
            <div className="mt-14 flex items-center justify-center gap-6">
              <a href="https://github.com/microboxlabs" aria-label="GitHub" className="text-ink-3 transition-colors hover:text-ink-1">
              ...
              <a href="https://x.com/microboxlabs" aria-label="X" className="text-ink-3 transition-colors hover:text-ink-1">
                <svg className="h-5 w-5" fill="currentColor" viewBox="0 0 24 24">
            ...
            <div className="mt-10 text-xs text-ink-4">
              <p>© {new Date().getFullYear()} MicroBox Labs</p>
              <div className="mt-3 flex justify-center gap-4">
                <a href="/privacy" className="transition-colors hover:text-ink-1">Privacidad</a>
                <a href="/terms" className="transition-colors hover:text-ink-1">Términos</a>
              </div>
            </div>
          </div>
        </div>
