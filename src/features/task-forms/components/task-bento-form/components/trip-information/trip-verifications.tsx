...
export default function TripVerifications({
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 gap-2 rounded-b-lg w-full">
      <div className="flex gap-2 items-center border-0 border-gray-200 dark:border-gray-500">
      ...
      <div className="flex gap-2 items-center border-0 border-gray-200 dark:border-gray-500 rounded-bl-lg">
