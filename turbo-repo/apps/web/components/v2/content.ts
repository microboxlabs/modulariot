...
export const content = {
  ...
  nav: {
      ...
      sections: [
        {
          ...
          items: [
            {
              icon: "signal",
              label: "Ingesta GPS Core",
              href: "/producto/ingesta-gps-core",
              desc: "Señales GPS y sensores en tiempo real hacia tu base de datos",
            },
            {
              icon: "radar",
              label: "Síntomas / Torre de Control",
              href: "/producto/sintomas-torre-control",
              desc: "30+ reglas de detección con trazabilidad",
            },
            {
              icon: "plug",
              label: "Integraciones",
              href: "/producto/integraciones",
              desc: "Workflows, webhooks y bóveda de evidencia",
            },
            {
              icon: "video",
              label: "Video en Vivo / HLS",
              href: "/producto/video-en-vivo",
              desc: "Streaming continuo desde cámaras y dashcams",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              desc: "Streaming, detección y flujos de trabajo",
            },
            {
              icon: "stack",
              label: "Arquitectura",
              href: "/producto/arquitectura",
              desc: "Del dispositivo edge a tu nube en <56ms",
            },
            {
              icon: "cloud",
              label: "Implementación",
              href: "/producto/implementacion",
              desc: "Tu nube, gestionado por MBL o edge híbrido",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              href: "/torre",
              desc: "Los 36 síntomas sobre una operación real",
            },
            {
              icon: "stack",
              label: "SuperProfile",
              href: "/superprofile",
              desc: "La identidad operacional viva de cada actor",
            },
            {
              icon: "plug",
              label: "Canales de escalamiento",
              href: "/canales",
              desc: "El síntoma en correo, WhatsApp, Teams, Webex y SMS",
            },
            {
              icon: "signal",
              label: "Proveedores GPS",
              href: "/proveedores-gps",
              desc: "Medimos la calidad de señal de 28 proveedores",
            },
          ],
        },
      ],
        ...
        columns: [
          {
            ...
            links: [
              {
                label: "Monitoreo de conductores y activos",
                href: "/soluciones#casos-de-uso",
              },
              {
                label: "Telemetría mecánica y mantenimiento",
                href: "/soluciones#casos-de-uso",
              },
              {
                label: "Cumplimiento y auditorías",
                href: "/soluciones#casos-de-uso",
              },
              {
                label: "Torre de control operacional",
                href: "/soluciones#casos-de-uso",
              },
            ],
          ...
          },
          {
            ...
            links: [
              ...
              {
                label: "Distribución y última milla",
    ...
    direct: [{ label: "Contacto", href: "/contacto" }] as {
      label: string;
      href: string;
      external?: boolean;
    }[],
  ...
  hero: {
    ...
    titlePost: ".",
    subtitle: "Convertimos tus alertas en mejoras reales para tu operación.",
    ...
    livePanel: {
      ...
      events: [
        {
          kind: "signal",
          title: "Señales llegando",
          detail: "2.847 activos reportando en tiempo real",
        },
        {
          kind: "symptom",
          title: "Síntoma detectado",
          detail: "Exceso de velocidad · ruta interna · severidad alta",
        },
        {
          kind: "action",
          title: "Escalado al responsable",
          detail: "supervisor notificado por SMS, con evidencia",
        },
        {
          kind: "record",
          title: "Queda registrado",
          detail: "en tu base de datos, en tu nube",
        },
      ],
    },
  },
    ...
    items: [
      {
        prefix: "Hasta",
        value: "55.847",
        label: "síntomas gestionados en un mes",
      },
      {
        prefix: "Un",
        value: "65%",
        label: "de las alertas tratadas se invalidan",
      },
  ...
  steps: {
    ...
    outro: {
      ...
      subtitle:
        "Desde la lectura del sensor hasta que el dato está en tu propia base de datos.",
    },
  },
  ...
  features: {
    ...
    subtitle:
      "Todo lo que necesitas para procesar, analizar y actuar sobre datos de flota en tiempo real",
    cards: [
      {
        icon: "signal",
        ...
        bullets: [
          "Una sola fuente para toda la telemetría",
          "Enriquecimiento y evaluación al instante",
          "Miles de eventos por segundo, sin batch",
        ],
      },
      {
        icon: "radar",
        ...
        bullets: [
          "Severidad y responsable automáticos",
          "Exclusión inteligente de ruido",
          "Acción disparada: SMS, panel u orden de trabajo",
        ],
      },
      {
        icon: "plug",
        ...
        bullets: [
          "Canal según el tipo de síntoma",
          "Ciclo bidireccional, no solo notificar",
  ...
  architecture: {
    ...
    subtitle:
      "Ve cómo fluyen tus datos desde dispositivos edge hasta tu nube en tiempo real",
    steps: [
      {
        n: "01",
        title: "Ingesta de datos",
        body: "Recopila datos GPS, sensores y eventos de tu flota en tiempo real",
      },
      {
        n: "02",
        title: "Procesamiento de streams",
        body: "Procesa y analiza flujos de datos con latencia subsegundo",
      },
      {
        n: "03",
        title: "Tu infraestructura",
        body: "Los datos fluyen directamente a tu base de datos, analítica y aplicaciones",
      },
    ],
    latency: "< 56 ms latencia mediana extremo a extremo",
    latencySubtitle:
      "Desde lectura del sensor hasta respuesta de tu aplicación",
  },
    ...
    cards: [
      {
        ...
        bullets: [
          "API de última señal por activo",
          "Tracking AVL en tiempo real",
          "CDC hacia tus sistemas downstream",
        ],
      },
      {
        id: "sintomas",
        ...
        bullets: [
          "Severidad y responsable automáticos",
          "Ciclo de vida: abrir → tratar → cerrar",
          "Exclusión inteligente de ruido",
        ],
      },
      {
        ...
        bullets: [
          "Workflows y webhooks (n8n)",
          "Bóveda de evidencia documental",
          "APIs y gateway para tus sistemas",
        ],
      },
      {
        id: "video",
        ...
        bullets: [
          "Streaming HLS 24h continuo",
          "Frames desde cámaras y dashcams",
  ...
  deployment: {
    ...
    subtitle:
      "Una puesta en marcha gestionada por MicroBox Labs: nosotros operamos la infraestructura, tú te enfocas en la operación.",
    soonLabel: "Próximamente",
    includes: [
      {
        title: "Configuración a tu operación",
        body: "Umbrales, zonas y reglas ajustados a cómo trabajas, no una plantilla genérica.",
      },
      {
        title: "Despliegue en tu nube",
        body: "Corre en tu infraestructura (AWS, Azure o GCP); tus datos nunca salen de tu control.",
        soon: true,
      },
      {
        title: "Conectado a tus sistemas",
        body: "Integración vía API con las plataformas que ya usas (despacho, mantención, ERP); se suma a tu operación, no la reemplaza.",
      },
      {
        title: "Canales de tu operación",
        body: "Correo, WhatsApp, Teams, Webex y SMS conectados para que la alerta llegue donde vive el equipo.",
      },
      {
        title: "Puesta en marcha gestionada",
        body: "MicroBox Labs opera y acompaña la operación, sin overhead de DevOps de tu lado.",
      },
      {
        title: "Monitoreo, soporte y actualizaciones",
        body: "La plataforma se mantiene al día y monitoreada sin que te ocupes.",
      },
    ],
  },
