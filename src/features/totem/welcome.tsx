...
export default function Welcome({ setCurrentOption, currentOption, dict }: { setCurrentOption: (option: number) => void, currentOption: number, dict: I18nRecord }) {
  return (
    <div className="flex flex-col items-center justify-center w-full h-full gap-10">
        ...
        <div className="flex flex-col items-center justify-center p-3 rounded-md gap-10">
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-[4vh] portrait:text-[4vw] text-gray-500 ">{(dict.totem as I18nRecord).subtitle as string}</p>
          </div>
          {/* Form */}
          <div className="flex flex-col items-center justify-center w-full">
            <button onClick={() => setCurrentOption(currentOption + 1)} className="bg-blue-500 text-white p-4 rounded-2xl w-full flex items-center justify-center gap-2">
              <p className="text-[4vh] portrait:text-[4vw] font-light">{(dict.totem as I18nRecord).start as string}</p>
