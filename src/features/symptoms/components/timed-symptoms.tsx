        ...
        {test_data.map((item) => (
          <div className="flex flex-col items-center justify-center mb-2">
            ...
            <div className="grid grid-cols-3 w-full p-3 gap-2">
              <p>
                Conductor: <span className="text-gray-500 dark:text-gray-400">{item.driver}</span>
              </p>
              <p>
                Modelo: <span className="text-gray-500 dark:text-gray-400">Volvo Gama FH</span>
              </p>
              <p>
                Tiempo de trayecto: <span className="text-gray-500 dark:text-gray-400">16:33:12 hrs</span>
              </p>
              <p>
                Contacto: <span className="text-gray-500 dark:text-gray-400">+56 9 8348 5032</span>
              </p>
              <p>
                Tipo de carga: <span className="text-gray-500 dark:text-gray-400">Rampla</span>
              </p>
              <p>
                Otros: <span className="text-gray-500 dark:text-gray-400">xxxxxxxx</span>
              </p>
            </div>
            { /* Diagnose button */}
