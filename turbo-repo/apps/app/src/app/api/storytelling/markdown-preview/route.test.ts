...
vi.mock("node:fs/promises", async (importOriginal) => ({
  ...
  readFile: vi.fn().mockResolvedValue("# Demo"),
}));

import { GET } from "./route";

describe("GET /api/storytelling/markdown-preview", () => {
  ...
  it("serves the fixture markdown when flag is on and authenticated", async () => {
    const res = await GET();
