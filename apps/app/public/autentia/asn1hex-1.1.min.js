...
ASN1HEX.dump = function (e, c, k, g) {
  ...
  if (e.substr(k, 2) == "0c") {
    return (
      g + "UTF8String '" + hextoutf8(ASN1HEX.getHexOfV_AtObj(e, k)) + "'\n"
    );
  }
  if (e.substr(k, 2) == "13") {
    return (
      g + "PrintableString '" + hextoutf8(ASN1HEX.getHexOfV_AtObj(e, k)) + "'\n"
    );
  }
  if (e.substr(k, 2) == "14") {
    return (
      g + "TeletexString '" + hextoutf8(ASN1HEX.getHexOfV_AtObj(e, k)) + "'\n"
    );
  }
  if (e.substr(k, 2) == "16") {
  ...
  if (e.substr(k, 2) == "18") {
    return (
      g + "GeneralizedTime " + hextoutf8(ASN1HEX.getHexOfV_AtObj(e, k)) + "\n"
    );
  }
  if (e.substr(k, 2) == "30") {
