...
export type PartnerLogo = { name: string; href?: string; img?: string; invert?: boolean; tall?: boolean };

export const GPS_PARTNERS: readonly PartnerLogo[] = [
  { name: "Mintral", href: "https://www.mintral.cl/", img: "/clients/mintral-logo.png" },
  ...
  { name: "TrackTec", href: "https://tracktec.cl", img: "/partners/tracktec.png", tall: true },
