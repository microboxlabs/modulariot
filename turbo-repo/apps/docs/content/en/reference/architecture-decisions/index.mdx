...
| [ADR-002](/reference/architecture-decisions/adr-002-api-gateway-apisix) | API Gateway — Apache APISIX replacing ingress-nginx for traffic management, quotas, and payload routing | Accepted |
