    ...
    <div className="flex flex-col gap-5 p-10 h-full">
      <div className="flex flex-col gap-2 h-[90%] overflow-y-auto">
        ...
        >
          <div className="flex flex-col gap-2">
            ...
            <p className="text-sm">
              Síntoma observado:{" "}
              <span className="text-gray-500">{data.trip.alertType}</span>
            </p>
            <p className="text-sm">
              Evento:{" "}
              <span className="text-gray-500">
                4.5 Horas de conducción sin descanso
              </span>
            </p>
            <p className="text-sm">
            ...
            <p className="text-sm">
              Tiempo de trayecto:{" "}
              <span className="text-gray-500">16:33:12 hrs</span>
            </p>
            <p className="text-sm">
              Servicio:{" "}
              <span className="text-gray-500">{data.trip.service}</span>
            </p>
            <p className="text-sm">
              Prescripción recomendada:{" "}
              <span className="text-gray-500">Llamar al conductor</span>
            </p>
          </div>
        </ExpandableButton>
          ...
          <div className="flex flex-col gap-2">
            {data.actions.map((action, index) => (
              <div key={index} className="flex flex-col gap-2 p-1 ">
                <p className="rounded-md bg-gray-200 w-full p-2 px-5">
                  {index + 1}.
                </p>
      ...
      <div className="flex flex-col justify-self-end">
        <Button.Group className="w-full">
          <BlurrableDropdown />
          <Button size="md" color="blue" className="h-10 rounded-l-none w-full">
            Llamar al conductor
