...
import { Card, Badge, Accordion, AccordionPanel, AccordionTitle, AccordionContent, Tabs, TabsHead, TabsHeadItem, TabsBody, TabsBodyItem } from "flowbite-react";
import { Copy, Check, ChevronDown, ChevronRight } from "lucide-react";
import { ConnectionDetails } from "./protocolHelpers";
            ...
            <div className="border rounded-lg p-4 bg-gray-50 space-y-3">
              ...
              {details.sampleCode && (
                <div className="mt-4">
                  ...
                  <Tabs.Group aria-label="Sample code tabs" style="underline">
