...
import { Server, Wifi, Waves, MessageCircle, Terminal, X } from "lucide-react";
import { ConnectionCard } from "./ConnectionCard";
import { PROTOCOLS, getConnectionDetails } from "./protocolHelpers";
...
export function ConnectStreamModal({ isOpen, onClose }: ConnectStreamModalProps) {
