...
slotted in via the same dimensions and clear-space rules. Tenant logos are NOT shipped on this marketing site; they live
...
Run-1 of the ralph loop rescued tenant SVG logos from
`apps/web-site/public/` thinking they were Modular IoT platform brand. They
were actually a customer's assets (Selective Yellow `#FFB017` + Blaze Orange
`#C54600` — that tenant's mining-logistics brand). Those were purged in PA-iter-2
