...
const BACKGROUND_PATHS = {
  ...
  innerColor: (color: string) => `<path d="M12.5504 11.5877C13.6671 9.7146 16.3079 9.71461 17.4245 11.5877C20.6413 16.9833 25.9015 26.4695 25.9015 30.8041C25.9015 37.0478 21.0151 42.1094 14.9875 42.1094C8.95984 42.1094 4.07347 37.0478 4.07347 30.8041C4.07347 26.4695 9.3337 16.9833 12.5504 11.5877Z" fill="${color}"/>`,
  outerLine: (color: string) => `<path d="M17.0183 5.50805C19.0142 8.80935 21.8789 13.7421 24.243 18.5737C25.4252 20.9898 26.4782 23.3723 27.2345 25.5078C27.9948 27.6542 28.4394 29.5076 28.4394 30.8804C28.4394 38.588 22.4064 44.8066 15.0001 44.8066C7.59374 44.8066 1.56069 38.588 1.56069 30.8804C1.56069 29.5076 2.00528 27.6542 2.76557 25.5078C3.52195 23.3723 4.5749 20.9898 5.75709 18.5737C8.12119 13.7421 10.9859 8.80935 12.9818 5.50805C13.915 3.9646 16.0851 3.9646 17.0183 5.50805Z" stroke="${color}"/>`
};
