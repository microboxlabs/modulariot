...
export default function TermsOfService() {
  return (
    <LegalPageLayout title="Terms of Service" lastUpdated="February 3, 2026" activeLink="terms">
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">1. Agreement to Terms</h2>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">3. Description of Services</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">4. Account Registration and Security</h2>
        <p className="text-ink-2 mb-4">When you create an account, you agree to:</p>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">5. Acceptable Use</h2>
        <p className="text-ink-2 mb-4">You agree not to use the Services to:</p>
        <ul className="list-disc list-inside text-ink-2 space-y-2 ml-4">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">6. Your Data and Content</h2>
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">7. Intellectual Property</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">8. Fees and Payment</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">9. Disclaimers</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">10. Limitation of Liability</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">11. Indemnification</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">12. Termination</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">13. Governing Law and Disputes</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">14. Changes to the Terms</h2>
        <p className="text-ink-2 leading-relaxed">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">15. General</h2>
        <p className="text-ink-2 mb-4">
      ...
      <section className="mb-10">
        <h2 className="text-2xl font-semibold text-accent mb-4">16. Contact Us</h2>
        <p className="text-ink-2 leading-relaxed">
        ...
        <div className="mt-4 p-6 bg-surface-2 rounded-lg border border-hairline">
          ...
          <p className="text-ink-2 mt-2">Email: <a href="mailto:legal@modulariot.com" className="text-accent hover:text-accent-strong">legal@modulariot.com</a></p>
