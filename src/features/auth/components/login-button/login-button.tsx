...
import type { AuthProviderIcon } from "../../config/auth-providers.types";
import type { FC, SVGProps } from "react";

// SVG Icons for providers not in flowbite-react-icons
...
const ICON_MAP: Record<AuthProviderIcon, FC<SVGProps<SVGSVGElement>>> = {
  google: GoogleIcon,
  github: GitHubIcon,
  microsoft: Windows,
  user: User,
