 ...
 *
 * Thin proxy over Alfresco Share's `/alfresco/s/api/groups?shortNameFilter=…`
 * webscript. Returns an array of AuthoritySuggestion entries for autocomplete.
 *
 * Requires a trimmed term of at least 3 characters to avoid proxying short
 * prefixes that would match too many authorities and waste both client and
 * Alfresco resources.
 */
