...
export default function TripInformation({ setCurrentStep, currentStep }: { setCurrentStep: (step: number) => void, currentStep: number }) {
  ...
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl p-10 bg-white dark:bg-gray-800">
      <h1 className="text-[4vh] portrait:text-[4vw] text-gray-900 dark:text-gray-100">Información del viaje</h1>
      ...
      <div className="flex flex-row items-stretch justify-center gap-3 w-full my-[2vh]">
        <div className="flex flex-col justify-center gap-[1vh] w-full">
          <h1 className="text-[3vh] portrait:text-[3vw] font-light text-gray-900 dark:text-gray-100">Información del viaje</h1>
          <div className="flex flex-col justify-center gap-1 w-full">
            <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Información del cliente: <span className="font-light">Lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quos.</span></h1>
            <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Origen - Destino: <span className="font-light">xxx - xxx</span></h1>
            <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Horario: <span className="font-light">8:00 am - 16:00 pm</span></h1>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex flex-col items-center justify-center gap-7 w-full">
      <div className="flex flex-col justify-center w-full">
        ...
        <h1 className="text-[2vh] portrait:text-[2vw] font-light text-gray-900 dark:text-gray-400">Conductor {number}</h1>
      </div>
      <div className="flex flex-col justify-center gap-3 w-full">
        <h1 className="text-[2.5vh] portrait:text-[2.5vw] font-bold text-gray-900 dark:text-gray-100">Información contacto</h1>
        <div className="flex flex-col justify-center gap-[1vh] w-full">
          <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Correo electrónico: <span className="font-light">{email}</span></h1>
          <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Estado: <span className="font-light">{state}</span></h1>
          <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Teléfono: <span className="font-light">{phone}</span></h1>
          <h1 className="text-[2vh] portrait:text-[2vw] font-bold text-gray-900 dark:text-gray-400">Rut: <span className="font-light">{rut}</span></h1>
        </div>
      </div>
    </div>
  )
