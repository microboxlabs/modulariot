...
// Panel "operación en vivo" del hero: eventos en lenguaje de negocio que
// aparecen en secuencia (efecto en vivo) y reinician en loop. Sustituye al
// antiguo terminal de logs con jerga técnica.
      ...
      <div className="overflow-hidden rounded-2xl border border-white/10 bg-gray-950 shadow-xl">
        ...
        <div className="flex items-center justify-between border-b border-white/10 px-5 py-3.5">
          <div className="flex items-center gap-2.5">
            <span className="flex h-8 w-8 items-center justify-center rounded-lg bg-white/5 text-blue-300">
