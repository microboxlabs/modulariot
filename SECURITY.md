...
ModularIoT is under active development and has not yet reached a stable 1.0
...
1. Go to the [Security tab](https://github.com/microboxlabs/modulariot/security)
   of this repository.
...
- The affected workspace (`quarkus-srv`, `ecm-srv`, `turbo-repo`, or `miot-harness`)
  and file paths or components involved.
