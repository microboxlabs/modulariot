...
export default function CustomThemeToggle() {
  return (
    <div>
      <DarkThemeToggle
        className="h-10 w-10 select-none cursor-pointer relative flex items-center justify-center p-2 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 transition-all duration-300 ring-0 hover:border-gray-300 dark:hover:border-gray-600 active:ring-2 active:ring-gray-300 dark:active:ring-gray-600"
        onClick={async () => {
          // Get current theme
        ...
        theme={{
          root: {
            base: "bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 ring-0 active:border-0",
          },
        }}
      />
    </div>
