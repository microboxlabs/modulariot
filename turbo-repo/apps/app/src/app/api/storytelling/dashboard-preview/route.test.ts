...
vi.mock("node:fs/promises", async (importOriginal) => ({
  ...
  readFile: vi.fn().mockResolvedValue("<html><body>fixture</body></html>"),
}));

import { GET } from "./route";

describe("GET /api/storytelling/dashboard-preview", () => {
  ...
  it("serves the fixture HTML when flag is on and authenticated", async () => {
    const res = await GET();
