...
import { DASHLET_ICON_OPTIONS } from "./icon-options";

interface IconColorPickerRowProps<TIcon extends string, TColor extends string> {
  icon: TIcon;
  onIconChange: (icon: TIcon) => void;
...
export function IconColorPickerRow<TIcon extends string, TColor extends string>({
  icon,
  onIconChange,
  colorOptions,
  color,
  onColorChange,
  dictionary,
}: Readonly<IconColorPickerRowProps<TIcon, TColor>>) {
  return (
    <SettingsPickerRow>
