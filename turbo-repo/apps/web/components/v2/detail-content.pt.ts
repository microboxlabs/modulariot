  ...
  "producto/ingesta-gps-core": {
    ...
    blocks: [
      ...
      },
      {
        type: "code",
        kicker: "Como fica",
        title: "Configure o pipeline em minutos",
        cards: [
          {
    ...
    blocks: [
      {
        ...
        subtitle: "Processe cada sinal conforme ele chega, com latência subsegundo.",
        cards: [
          {
