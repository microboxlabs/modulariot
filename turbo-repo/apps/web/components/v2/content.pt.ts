...
export const pt = {
  nav: {
      ...
      sections: [
        {
          ...
          items: [
            {
              icon: "signal",
              label: "Ingestão GPS Core",
              href: "/producto/ingesta-gps-core",
              desc: "Sinais GPS e sensores em tempo real para o seu banco de dados",
            },
            {
              icon: "radar",
              label: "Sintomas / Torre de Controle",
              href: "/producto/sintomas-torre-control",
              desc: "Mais de 30 regras de detecção com rastreabilidade",
            },
            {
              icon: "plug",
              label: "Integrações",
              href: "/producto/integraciones",
              desc: "Workflows, webhooks e cofre de evidências",
            },
            {
              icon: "video",
              label: "Vídeo ao Vivo / HLS",
              href: "/producto/video-en-vivo",
              desc: "Streaming contínuo de câmeras e dashcams",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              desc: "Streaming, detecção e fluxos de trabalho",
            },
            {
              icon: "stack",
              label: "Arquitetura",
              href: "/producto/arquitectura",
              desc: "Do dispositivo edge à sua nuvem em <56ms",
            },
            {
              icon: "cloud",
              label: "Implantação",
              href: "/producto/implementacion",
              desc: "Sua nuvem, gerenciado pela MBL ou edge híbrido",
            },
          ],
        },
        {
          ...
          items: [
            {
              ...
              href: "/torre",
              desc: "Os 36 sintomas sobre uma operação real",
            },
            {
              icon: "stack",
              label: "SuperProfile",
              href: "/superprofile",
              desc: "A identidade operacional viva de cada ator",
            },
            {
              icon: "plug",
              label: "Canais de escalonamento",
              href: "/canales",
              desc: "O sintoma em e-mail, WhatsApp, Teams, Webex e SMS",
            },
            {
              icon: "signal",
              label: "Provedores GPS",
              href: "/proveedores-gps",
              desc: "Medimos a qualidade de sinal de 28 provedores",
            },
          ],
        },
      ],
        ...
        columns: [
          {
            ...
            links: [
              {
                label: "Monitoramento de motoristas e ativos",
                href: "/soluciones#casos-de-uso",
              },
              {
                label: "Telemetria mecânica e manutenção",
                href: "/soluciones#casos-de-uso",
              },
              {
                label: "Conformidade e auditorias",
                href: "/soluciones#casos-de-uso",
              },
              {
                label: "Torre de controle operacional",
                href: "/soluciones#casos-de-uso",
              },
            ],
          ...
          },
          {
            ...
            links: [
              ...
              {
                label: "Distribuição e última milha",
    ...
    direct: [{ label: "Contato", href: "/contacto" }],
  ...
  deployment: {
    ...
    title: "Implantação",
    subtitle:
      "Uma colocação em operação gerenciada pela MicroBox Labs sobre a sua própria nuvem: nós operamos a infraestrutura, você foca na operação. No ar em dias, não meses.",
    soonLabel: "Em breve",
    includes: [
      {
        title: "Configurado à sua operação",
        body: "Limites, zonas e regras ajustados a como você trabalha — não um modelo genérico.",
      },
      {
        title: "Implantado na sua nuvem",
        body: "Roda na sua própria infraestrutura (AWS, Azure ou GCP); seus dados nunca saem do seu controle.",
        soon: true,
      },
      {
        title: "Conectado aos seus sistemas",
        body: "Integração via API com as plataformas que você já usa (despacho, manutenção, ERP); soma-se à sua operação, não a substitui.",
      },
      {
        title: "Canais da sua operação",
        body: "E-mail, WhatsApp, Teams, Webex e SMS conectados para que o alerta chegue onde o time vive.",
      },
      {
        title: "Colocação em operação gerenciada",
        body: "A MicroBox Labs opera e acompanha a operação, sem overhead de DevOps do seu lado.",
      },
      {
        title: "Monitoramento, suporte e atualizações",
        body: "A plataforma se mantém atualizada e monitorada sem que você precise se ocupar.",
      },
    ],
  },
